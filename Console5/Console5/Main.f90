...
!=============================================================================!
 ...
 real(DP), dimension(:), allocatable ::   Y_VALUE, OUTPUT_RESULT,GREEN_FUNCTION
...
CALL GLA%ALLCOATE_ARRAY( NUMBER_GAUSS_POINTS)
 ...
 case(2)
     ...
     do JJ = 1, 8
       ...
       call     integral_kernel_laguerre( X_VALUE( II ), Y_VALUE( JJ ), GLA, SPECIAL_FUNCTION, GREEN_FUNCTION)    !------------------FIRST TERMS
       
         OUTPUT_RESULT (JJ )  =  GREEN_FUNCTION(1)
